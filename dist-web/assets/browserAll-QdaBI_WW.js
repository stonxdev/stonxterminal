...
import "./webworkerAll-BVxsgAfo.js";
import "./colorToUniform-DmtBy-2V.js";
class M {
  constructor(e) {
    (this.bubbles = !0),
      (this.cancelBubble = !0),
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (!r.parent || r.globalDisplayStatus < 7)
        ...
        (l.style.transformOrigin = `${c}px ${h}px`),
          (l.style.transform = `matrix(${d.a}, ${d.b}, ${d.c}, ${d.d}, ${d.tx - c}, ${d.ty - h})`),
  ...
  B = class k {
    ...
    setCursor(e) {
      ...
      if (i)
        ...
        t &&
          typeof e == "string" &&
          !Object.hasOwn(this.cursorStyles, e) &&
...
const _e = {
  ...
  addEventListener(a, e, t) {
    ...
    n &&
      ...
      s ? this.once(a, r, o) : this.on(a, r, o);
  },
...
w.mixin(Z, _e);
w.add(q);
//# sourceMappingURL=browserAll-QdaBI_WW.js.map
